<template>
            ...
            <div class="form-v5-content">
                <form class="form-detail" action="#" method="post">
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" v-model="email" id="your-email" class="input-text" placeholder="Your Email" required pattern="[^@]+@[^@]+.[a-zA-Z]{2,6}">
                        <i class="fas fa-envelope"></i>
                    </div>
                    <div class="form-row">
                        <label for="password">Password</label>
                        <input type="password" v-model="password"  id="password" class="input-text" placeholder="Your Password" required>
                    ...
                    <div class="form-row-last">
                        <input v-on:click="SignUp" type="button"  class="register" value="Register">
                    </div>
                </form>
            </div>
        </div>
   ...
   export default{
    ...
    methods:{
       async SignUp(){
            let result = await axios.post("http://localhost:3000/api", {
                name:this.name,
                email:this.email,
